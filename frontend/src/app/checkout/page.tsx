...
// using standard alert for mock checkout
...
export default function CheckoutPage() {
  ...
  const handleCheckout = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      alert('Payment successful! Taking you to your ticket...');
      router.push('/success');
    }, 2500);
  };
    ...
    <div className="flex-1 bg-background-light dark:bg-background-dark py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1">Complete your purchase within <span className="text-red-500 font-semibold timer-pulse">04:59</span> to secure your tickets.</p>
        </div>
                   ...
                   <div className="grid grid-cols-2 gap-4 mb-8">
                        ...
                        >
                         ...
                         <button 
                            ...
                            className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${paymentMethod === 'paypal' ? 'border-primary bg-primary/5 text-primary' : 'border-slate-200 dark:border-slate-800 text-slate-500 hover:border-slate-300 dark:hover:border-slate-700'}`}
                        >
            ...
            <div className="w-full lg:w-96">
                <div className="bg-slate-50 dark:bg-surface-dark border border-slate-200 dark:border-border-dark rounded-2xl p-6 sticky top-24">
                    ...
                    <div className="flex gap-4 mb-6 pb-6 border-b border-slate-200 dark:border-slate-800">
                        ...
                        />
                        <div>
                            <h4 className="font-bold text-slate-900 dark:text-white">Neon Nights Festival</h4>
                            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 flex items-center gap-1"><Icon name="calendar_today" className="text-[14px]"/> Oct 15, 2026</p>
                            <p className="text-sm text-slate-500 dark:text-slate-400 flex items-center gap-1"><Icon name="location_on" className="text-[14px]"/> O2 Arena, London</p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between items-end mb-6">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-slate-900 dark:text-white">$195.00</p>
                        </div>
                        <span className="text-sm font-medium text-primary bg-primary/10 px-2 py-1 rounded">USD</span>
                    </div>
